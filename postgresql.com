...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-12-04T22:55:37.310513" />
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6eZ"> PostgreSQL Events – A Newbies Perspective: #PGSQLPhriday 014</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6eY"> PostgreSQL with Python – A Developer’s Guide</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6eX"> Seattle Postgres User Group and PASS Summit – PGSQL Phriday #014</a></h3>
            <ul class="meta">
